    ...
    def as_tool_spec(self) -> dict:
        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    "Execute an EmojiASM program. EmojiASM is a stack-based "
                    "assembly language with emoji opcodes. Returns numerical "
                    "results from parallel GPU execution."
                ),
                "parameters": {
                    "type": "object",
                    "properties": {
                        "source": {
                            "type": "string",
                            "description": "EmojiASM source code using emoji opcodes",
                        },
                        "instances": {
                            "type": "integer",
                            "description": (
                                "Number of parallel instances to run (default: 1)"
                            ),
                            "default": 1,
                        },
                    },
